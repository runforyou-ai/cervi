...
1. 客服闭环：首发市场为海外，首发渠道为网站与 Telegram。验证闭环的主干已交付，当前补齐真实客户试用所需的完整度：联系人资料与客户档案 → AI 质检、推断满意度与回答质量评测 → 真人运营指标；海外第一批渠道与上述事项并行推进 → 国内渠道、第二批渠道、自定义 API 渠道、开放接口与权限。常用语与 Messenger 语音消息按需启动。
...
网站渠道选择发布的知识库，文本文档与问答条目作为文章供访客浏览和搜索。以下事项按启动条件开启：
