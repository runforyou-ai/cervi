...
1. 客服闭环：首发市场为海外，首发渠道为网站与 Telegram。问答草稿与 AI 回复复核 → 离线回复通知、AI 翻译与多语言内置指令 → 网站 Messenger 占位能力、常用语、联系人资料、AI 满意度与质检、真人运营指标 → 海外第一批渠道 → 国内渠道、第二批渠道、自定义 API 渠道、开放接口与权限。
...
| 事项 | 做法 |
|---|---|
| 问答草稿 | 转人工后真人已答复的问题，由 AI 按真人回复起草知识库问答条目，管理员确认后入库；知识缺口清单中的问题可直接查看对应草稿。与「AI 回复复核」同一批交付，共用草稿确认入库链路 |
