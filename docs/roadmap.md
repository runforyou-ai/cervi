...
移动端与桌面端共用消息时间线、输入框、客服会话操作、客服侧栏、群设置和会话列表菜单。AI 员工、渠道、知识库、工具、模型服务、成员、角色、团队管理、AI 表现、企业与客服设置等管理页面只在 Web 与桌面端提供，移动端不设入口。以下 PR 补齐移动端日常使用的差距。

**移动端外部联系人编辑。**

- 外部联系人详情支持编辑名称、阶段、邮箱、电话和备注，列表支持新建联系人和按阶段筛选。
- 桌面端外部联系人列表页头补回新建入口。
- 删除、回收站与恢复、按渠道和联系方式筛选、排序留在桌面端；客户会话资料中的联系人信息随「联系人资料」交付。
- 验收：客服在移动端通讯录新建联系人、修改阶段与备注后，桌面端联系人详情同步更新；桌面端可新建联系人。

**移动端助理编辑。**

- 助理详情提供编辑入口，可修改头像、名称、模型、指令和知识库；助理列表支持按名称搜索。
- 新建助理与换电脑只在桌面端提供。
- 验收：在移动端修改助理的名称、指令和知识库后，任意端与该助理对话都按新配置回复，桌面端编辑页同步显示。
