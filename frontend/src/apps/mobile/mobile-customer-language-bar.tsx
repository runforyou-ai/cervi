...
/** 需要翻译时展示客户语言，点击打开底部面板切换显示原文与回复语言，修改立即生效。 */
export function MobileCustomerLanguageBar() {
    ...
    <div className="flex h-11 shrink-0 items-center border-b">
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger asChild>
          <Button
            variant="ghost"
            className="min-h-11 min-w-0 max-w-full justify-start gap-2 overflow-hidden px-4 text-xs font-normal text-muted-foreground"
          >
