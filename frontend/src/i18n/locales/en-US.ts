...
const enUS = {
  ...
  workspace: {
    ...
    tabs: {
      ...
      pin: "Pin",
      unpin: "Unpin",
      unsavedTab: "{{title}}, with unsaved changes",
      pinnedTab: "{{title}}, pinned",
      unsavedTitle: "Close unsaved pages?",
      unsavedDescription: "Any changes that have not been saved will be lost.",
      reloadUnsavedTitle: "Reload an unsaved page?",
      reloadUnsavedDescription:
        "Any changes that have not been saved will be lost after reloading.",
      ...
      routes: {
        ...
        knowledgeBase: "Edit knowledge base",
        channels: "Message channels",
        newChannel: "Add channel",
        channel: "Channel settings",
        businessSystems: "Business systems",
        newBusinessSystem: "Add business system",
        businessSystem: "Edit business system",
        chatProviders: "Chat models",
        newChatProvider: "Add provider",
        chatProvider: "Edit provider",
        embeddingProviders: "Embedding models",
        newEmbeddingProvider: "Add provider",
        embeddingProvider: "Edit provider",
        rerankProviders: "Rerank models",
        newRerankProvider: "Add provider",
        rerankProvider: "Edit provider",
        connectors: "Connectors",
        newConnector: "Add connector",
  ...
  knowledgeBase: {
    ...
    form: {
      ...
      demoDifyIntegration: "Dify demo connection",
      demoDifyDocumentKnowledgeBase: "Dify demo document knowledge base",
      demoDifyQAKnowledgeBase: "Dify demo Q&A knowledge base",
      create: "Create",
      save: "Save",
      saving: "Saving…",
  ...
  inbox: {
    ...
    threadComingSoon: "Message content is in development",
    sessionStatus: {
      waiting: "Waiting",
      active: "Active",
      pending: "On hold",
