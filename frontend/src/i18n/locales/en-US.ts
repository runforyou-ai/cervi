  ...
  settings: {
    ...
    aiProviders: {
      ...
      models: {
        ...
        minimumDimension: "Minimum dimension",
        maximumDimension: "Maximum dimension",
        dimensionOptions: "Available dimensions (comma-separated)",
        types: {
          chat: "Chat",
          embedding: "Embedding",
          rerank: "Rerank",
      ...
      validation: {
        ...
        maxOutputTokensInvalid:
          "Maximum output tokens must be positive, such as 8192, 64K, or 1M.",
        dimensionModeInvalid: "Select an embedding dimension mode.",
        defaultDimensionInvalid:
          "Default dimension must be a positive integer.",
        dimensionRangeInvalid:
          "Enter a valid range containing the default dimension.",
        dimensionOptionsInvalid:
          "Enter unique positive dimensions including the default dimension.",
        modelIdentifierDuplicate: "Model IDs must be unique.",
      },
    },
    roles: {
