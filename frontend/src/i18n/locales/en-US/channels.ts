...
const channels = {
  ...
  chatInterface: {
    form: {
      ...
      homeLinksDescription:
        "Shown on the Messenger home screen. Visitors open them in a new tab.",
      homeLinkTitle: "Title",
      homeLinkURL: "Link URL",
      addHomeLink: "Add link",
      moveHomeLinkUp: "Move link {{number}} up",
      moveHomeLinkDown: "Move link {{number}} down",
      removeHomeLink: "Remove link {{number}}",
    },
    validation: {
      ...
      homeLinkTitleRequired: "Enter a link title.",
      homeLinkTitleTooLong: "The link title cannot exceed 100 characters.",
      homeLinkURLInvalid: "Enter a valid URL starting with http:// or https://.",
    },
    preview: {
      title: "Live preview",
