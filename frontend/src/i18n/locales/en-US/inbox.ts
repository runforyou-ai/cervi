...
const inbox = {
  ...
  agentPickerTitle: "Choose an AI",
  agentPickerDescription: "Choose an AI employee or one of your assistants to start a new chat.",
  agentPickerEmpty: "No AI employees or assistants available",
  ...
  customerMentionUnread: "Customer conversation mentions: {{count}}",
