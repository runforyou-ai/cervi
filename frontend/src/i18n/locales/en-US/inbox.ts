...
const inbox = {
  ...
  assistantDisplayName: "{{owner}}'s assistant · {{name}}",
  assistantOwnerLabel: "{{owner}}'s assistant",
  ...
  agentRunToolchainVerifyFailed: "Couldn't prepare the work environment: the downloaded files failed verification. Retrying automatically",
  agentRunToolchainInstallFailed: "Couldn't prepare the work environment: installation on this computer didn't finish. Retrying automatically",
  ...
  agentPlanTitle: "Tasks",
  agentPlanProgress: "{{done}}/{{total}}",
  ...
  translationShowTranslated: "Show translation",
  translationOriginal: "Original",
  translationFrom: "Translated from {{language}}",
  translationSentAs: "Sent in {{language}}",
  translationReply: "Translate",
  translationReplyOn: "Translate to {{language}} when sending",
  translationReplyOff: "Don't translate when sending",
  translationReplyOffHint: "Replies are sent to the customer as written",
  translationPreviewEmpty: "Type a reply to preview the translation",
  translationPreviewGenerating: "Translating…",
  translationPreviewError: "Translation failed. Try again.",
  translationPreviewSameLanguage: "The customer uses your language, so the reply is sent as written",
  translationBackTranslation: "Back-translation",
  translationPreviewRegenerate: "Translate again",
  translationPreviewSend: "Send translation",
  ...
  translationShowCustomerReceived: "Show what the customer received",
  translationReplyOnCustomer: "Translate to the customer's language when sending",
  translationCustomerLanguageUnknown: "Language not detected",
}
