...
const inbox = {
  ...
  chatPickerDescription: "Choose a colleague or AI colleague to start chatting.",
  ...
  localRunActive: "Local runs are on",
  localRunBoundTo: "Runs in {{workspace}} on \"{{device}}\"",
  localRunWorkspace: "Workspace",
  localRunOff: "Don't run locally",
  localRunAddWorkspace: "Add workspace",
  localRunTurnOff: "Turn off local runs",
  localRunDesktopOnly: "Open this conversation in the desktop app to set up local runs.",
  localRunLoadError: "Could not load the local run settings.",
  localRunBindError: "Could not set up local runs.",
  localRunUnbindError: "Could not turn off local runs.",
  localRunAddWorkspaceError: "Could not add the workspace.",
  typingDirect: "Typing…",
