...
const inbox = {
  ...
  assistantWorkspaceSelect: "选择工作区",
  assistantWorkspaceActive: "工作区：{{workspace}}",
  assistantWorkspaceLabel: "工作区",
  assistantWorkspaceNone: "不使用工作区",
  assistantWorkspaceAdd: "添加工作区",
  assistantWorkspaceClear: "清除工作区",
  assistantWorkspaceOnDevice: "在「{{device}}」的 {{workspace}} 中工作",
  assistantWorkspaceUnset: "未设置工作区，助理只能对话。",
  assistantWorkspaceBoundDevice: "在「{{device}}」上的 Cervi 中选择工作区。",
  assistantWorkspaceLoadError: "无法加载助理的工作区。",
  assistantWorkspaceSetError: "设置工作区失败。",
  assistantWorkspaceClearError: "清除工作区失败。",
  assistantWorkspaceAddError: "添加工作区失败。",
