...
const inbox = {
  ...
  chatPickerDescription: "选择同事或 AI 员工开始聊天。",
  ...
  localRun: "本机执行",
  localRunActive: "本机执行已开启",
  localRunBoundTo: "在「{{device}}」的 {{workspace}} 中执行",
  localRunWorkspace: "工作区",
  localRunOff: "不在本机执行",
  localRunAddWorkspace: "添加工作区",
  localRunTurnOff: "关闭本机执行",
  localRunDesktopOnly: "在桌面端打开此会话以设置本机执行。",
  localRunLoadError: "无法加载本机执行设置。",
  localRunBindError: "设置本机执行失败。",
  localRunUnbindError: "关闭本机执行失败。",
  localRunAddWorkspaceError: "添加工作区失败。",
  typingDirect: "正在输入…",
  typingOne: "{{name}} 正在输入…",
