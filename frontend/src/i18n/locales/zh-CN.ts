...
const zhCN = {
  ...
  workspace: {
    ...
    tabs: {
      ...
      pin: "固定",
      unpin: "取消固定",
      unsavedTab: "{{title}}，有未保存修改",
      pinnedTab: "{{title}}，已固定",
      unsavedTitle: "关闭未保存的页面？",
      unsavedDescription: "关闭后，尚未保存的修改将会丢失。",
      reloadUnsavedTitle: "重新加载未保存的页面？",
      reloadUnsavedDescription: "重新加载后，尚未保存的修改将会丢失。",
      keepEditing: "继续编辑",
      ...
      routes: {
        ...
        newBusinessSystem: "添加业务系统",
        businessSystem: "编辑业务系统",
        chatProviders: "对话模型",
        newChatProvider: "添加对话服务",
        chatProvider: "编辑对话服务",
        embeddingProviders: "嵌入模型",
        newEmbeddingProvider: "添加嵌入服务",
        embeddingProvider: "编辑嵌入服务",
        rerankProviders: "重排模型",
        newRerankProvider: "添加重排服务",
        rerankProvider: "编辑重排服务",
        connectors: "连接器",
        newConnector: "添加连接器",
        connector: "编辑连接器",
      },
  ...
  knowledgeBase: {
    ...
    form: {
      ...
      demoDifyIntegration: "Dify 示例连接",
      demoDifyDocumentKnowledgeBase: "Dify 示例文档知识库",
      demoDifyQAKnowledgeBase: "Dify 示例问答知识库",
      create: "创建",
      save: "保存",
      saving: "正在保存…",
