  ...
  settings: {
    ...
    aiProviders: {
      ...
      form: {
        ...
        saving: "保存中…",
        cancel: "取消",
        createSuccess: "AI 供应商已添加。",
        updateSuccess: "AI 供应商已保存。",
        saveError: "保存 AI 供应商失败，请重试。",
        loadError: "AI 供应商加载失败。",
      },
      models: {
        title: "模型目录",
        manualAdd: "手动添加",
        ...
        minimumDimension: "最小维度",
        maximumDimension: "最大维度",
        dimensionOptions: "可选维度（逗号分隔）",
        types: {
          chat: "对话",
          embedding: "向量",
          rerank: "重排序",
      ...
      delete: {
        ...
        deleting: "删除中…",
        success: "AI 供应商已删除。",
        error: "删除 AI 供应商失败，请重试。",
      },
      validation: {
        brandInvalid: "请选择支持的 AI 供应商品牌。",
        nameRequired: "请输入供应商名称。",
        nameTooLong: "供应商名称不能超过 100 个字符。",
        apiKeyRequired: "请输入 API 密钥。",
        apiKeyTooLong: "API 密钥不能超过 2048 个字符。",
        ...
        maxOutputTokensInvalid:
          "最大输出 token 数必须是正数，例如 8192、64K 或 1M。",
        dimensionModeInvalid: "请选择向量维度方式。",
        defaultDimensionInvalid: "默认维度必须是正整数。",
        dimensionRangeInvalid: "请输入有效的维度范围，且默认维度应在范围内。",
        dimensionOptionsInvalid: "请输入不重复的正整数维度，并包含默认维度。",
        modelIdentifierDuplicate: "模型标识不能重复。",
      },
    },
    roles: {
