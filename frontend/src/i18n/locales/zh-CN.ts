...
const zhCN = {
  ...
  contacts: {
    ...
    agents: {
      create: "添加 AI 员工",
      createDescription: "创建一个可以接待会话的 AI 员工。",
      form: {
        name: "AI 员工名称",
        teams: "所属团队",
        noTeams: "还没有可选择的团队。",
      ...
      status: {
        ...
        deactivateTitle: "停用“{{name}}”？",
        reactivateTitle: "恢复“{{name}}”？",
        deactivateDescription: "该 AI 员工将停止接待会话，所属团队关系会保留。",
        reactivateDescription: "该 AI 员工将恢复接待能力，原有团队关系保持不变。",
        cancel: "取消",
        confirm: "确认",
        saving: "正在处理…",
        deactivated: "AI 员工已停用",
        reactivated: "AI 员工已恢复",
        error: "修改 AI 员工状态失败，请重试。",
      },
    },
    teams: {
      create: "创建团队",
