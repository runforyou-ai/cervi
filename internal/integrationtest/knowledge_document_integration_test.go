...
func TestKnowledgeDocumentS3Preview(t *testing.T) {
	...
	backend := appservice.NewDirectBackend(db, domain.DeploymentModeSelfHosted, nil, s3, serverstorage.NewTenantResolver(db), nil, nil, nil, nil, nil, appservice.DeviceToolchainSources{})
