-- +goose Up
-- 删除企业业务系统表并移除企业的任意网址开关。
DROP TABLE business_systems;

ALTER TABLE organizations DROP COLUMN allow_arbitrary_url;
...
ALTER TABLE organizations ADD COLUMN allow_arbitrary_url boolean NOT NULL DEFAULT false;
