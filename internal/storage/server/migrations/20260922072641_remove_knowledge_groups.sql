-- +goose Up
ALTER TABLE knowledge_documents DROP COLUMN group_id;
ALTER TABLE knowledge_qa_entries DROP COLUMN group_id;
...
ALTER TABLE knowledge_documents ADD COLUMN group_id uuid NOT NULL;
ALTER TABLE knowledge_qa_entries ADD COLUMN group_id uuid NOT NULL;
