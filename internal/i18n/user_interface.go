...
const (
	...
	MessengerArticleCount           Key = "messenger.article_count"
	MessengerArticleCountOne        Key = "messenger.article_count_one"
	MessengerSearch                 Key = "messenger.search"
	MessengerHelpSearching          Key = "messenger.help_searching"
	MessengerHelpAnswer             Key = "messenger.help_answer"
	MessengerRelatedArticles        Key = "messenger.related_articles"
	MessengerHelpSearchFailed       Key = "messenger.help_search_failed"
	MessengerHelpArticleUnavailable Key = "messenger.help_article_unavailable"
