...
const (
	...
	ErrorAssistantWorkspaceLoadFailed  Key = "error.assistant_workspace_load_failed"
	ErrorAssistantWorkspaceSetFailed   Key = "error.assistant_workspace_set_failed"
	ErrorAssistantWorkspaceClearFailed Key = "error.assistant_workspace_clear_failed"
	ErrorAssistantNotInConversation    Key = "error.assistant_not_in_conversation"
