...
const (
	...
	ErrorKnowledgeContextReadFailed                Key = "error.knowledge_context_read_failed"
	ErrorKnowledgeContextNotFound                  Key = "error.knowledge_context_not_found"
	FieldKnowledgeContextInvalid                   Key = "field.knowledge_context_invalid"
