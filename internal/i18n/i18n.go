...
const (
	...
	ErrorChannelDeleteFailed              Key = "error.channel_delete_failed"
	ErrorChannelRestoreFailed             Key = "error.channel_restore_failed"
	...
	FieldUserRoleInvalid             Key = "field.user_role_invalid"
